...
1. **Matematyka to wąskie gardło matury** — zdawalność 88,4% vs 95,4% (polski)
   i 94,3% (angielski); najsłabszy przedmiot w 96% powiatów w 2025 r.
   (i w ~94% wszystkich powiato-lat 2023–2025). Rynek „ratowania matury”
   to ~30 tys. osób rocznie i rośnie.
